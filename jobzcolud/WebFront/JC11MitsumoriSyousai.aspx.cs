                ...
                if (!String.IsNullOrEmpty(Request.QueryString["id"]))
                {
                    if (!IsPostBack)
                    {
                        ...
                        if (dt_Syosai.Rows.Count > 0)
                        {
                            ...
                            String nRitu1 = (GV_MitumoriMeisai.Rows[rowindex].FindControl("lblMeisai_nRITU") as Label).Text; //20220518 MyatNoe Added
                            ...
                            if (rows.Length > 0)
                            {
                                foreach (var drow in rows)
                                {
                                    ...
                                    //dr[12] = drow[12].ToString(); //20220518 MyatNoe Delete
                                    dr[12] = nRitu1;                //20220518 MyatNoe Added
                    ...
                    if (dt_Syosai.Rows.Count > 0)
                    {
                        ...
                        if (rows.Length > 0)
                        {
                            foreach (var drow in rows)
                            {
                                ...
                                dr[11] = rowNo;
                                //dr[12] = drow[12].ToString(); //20220518 MyatNoe Delete
                                dr[12] = nRitu;                 //20220518 MyatNoe Added
                                dr[13] = drow[13].ToString();
                                dr[14] = drow[14].ToString();
                                dt.Rows.Add(dr);
                            }
