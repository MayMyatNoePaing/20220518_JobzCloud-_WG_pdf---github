...
<head runat="server">
    ...
    //20220520 MyatNoe Added End
</head>
<body id="BD_Master" runat="server" class="bg-transparent"> <%--20220518 MyatNoe Added--%>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional"><%--20220518 MyatNoe Added--%>
            <ContentTemplate>
