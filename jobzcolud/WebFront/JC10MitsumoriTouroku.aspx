                                                ...
                                                <asp:UpdatePanel ID="updJisyaBango" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:TextBox ID="txtJisyaBango" runat="server" AutoPostBack="true" MaxLength="10" CssClass="form-control TextboxStyle" onpaste="return false" AutoCompleteType="Disabled" 
                                                            onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" oninput="validateJapanese(this);" Width="80px" Height="28px" style="text-align:right;" OnTextChanged="txtJisyaBango_TextChanged" Font-Names="ＭＳ ゴシック"></asp:TextBox>
                                                    </ContentTemplate>
                                                    <Triggers>
