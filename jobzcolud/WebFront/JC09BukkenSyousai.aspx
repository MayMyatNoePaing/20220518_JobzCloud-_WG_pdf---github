    ...
    <head>
        ...
        <style>
            ...
            .JC09TextBox1 {
                ...
                width:80px;  /*20220425 Eaindray*/
                max-width: 80px; /*20220425 Eaindray*/
                height: 28px !important;
                text-align:right;
            }
                                                            ...
                                                            <td  style="cursor:context-menu;">
                                                                ...
                                                                <div class="no-ime" style="float: left; margin-left: 0px; margin-top: 20px; width: 150px; position: relative; border: none; text-align: center;"> 
                                                                    <asp:TextBox ID="tb_jishabangou" AutoPostBack="true"  runat="server" CssClass="form-control TextboxStyle JC09TextBox1" onpaste="return false"
                                                                        onkeyup="DeSelectText(this);" onfocus="this.setSelectionRange(this.value.length, this.value.length);" oninput="validateJapanese(this);" MaxLength="10" AutoCompleteType="Disabled" Font-Names="ＭＳ ゴシック" OnTextChanged="tb_jishabangou_TextChanged"></asp:TextBox>
